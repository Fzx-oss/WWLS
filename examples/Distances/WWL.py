...
def compute_wl_embeddings_discrete(graphs, h):
    ...
    # graphs = [ig.read(filename, format='picklez') for filename in graph_filenames]
    ...
    for h in hs:
        ...
        for graph_index_1, graph_1 in enumerate(label_sequences):
            ...
            for graph_index_2, graph_2 in enumerate(label_sequences[graph_index_1:]):
                ...
                costs = pairwise_distances(labels_1, labels_2, metric='hamming') / (h+1)
                ...
                if sinkhorn:
                    ...
                    M[graph_index_1, graph_index_2 + graph_index_1] = \
                        ot.emd2([], [], costs, numItermax=500000)
